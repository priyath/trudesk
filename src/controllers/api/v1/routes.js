...
module.exports = function (middleware, router, controllers) {
  ...
  router.get('/api/v1/tickets/dashboard-stats/:timespan', apiv1, canUser('tickets:view'), apiCtrl.tickets.getDashboardStats)
  router.get('/api/v1/tickets/summary', apiv1, canUser('tickets:view'), apiCtrl.tickets.getSummary);
